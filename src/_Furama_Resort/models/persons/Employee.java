...
public class Employee extends Person {
    ...
    public Employee(int id, String name, int birth, String gender, int idCard, int phoneNumber, String email, String employeeId, String level, String position, int salary) {
