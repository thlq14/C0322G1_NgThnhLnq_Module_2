...
public class Customer extends Person {
    ...
    public Customer(int id, String name, int birth, String gender, int idCard, int phoneNumber, String email, String customerId, String customerType, String customerAddress) {
